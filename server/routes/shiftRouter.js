...
router.get("/",    requireRoles(ROLES.ADMIN, ROLES.GENERAL_AFFAIR, ROLES.EMPLOYEE), shiftController.listShifts);
...
router.post("/",     requireRoles(ROLES.ADMIN, ROLES.GENERAL_AFFAIR), shiftController.createShift);
